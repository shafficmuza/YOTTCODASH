...
public class PoliceRecyclerViewAdapter extends RecyclerView.Adapter<PoliceRecyclerViewAdapter.MyViewHolder> {

    Context mContext;
    List<ServiceProvider> mData;
    Dialog myDialog;

    public PoliceRecyclerViewAdapter(Context mContext, List<ServiceProvider> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.police_list, parent, false);
        final MyViewHolder vHolder = new MyViewHolder(v);

        //get to dialog layout attributes
        myDialog = new Dialog(PoliceRecyclerViewAdapter.this.mContext);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_location = (TextView) itemView.findViewById(R.id.sp_location);
            tv_phone = (TextView) itemView.findViewById(R.id.sp_phone);
