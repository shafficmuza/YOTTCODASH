...
public class HealthRecyclerViewAdapter extends RecyclerView.Adapter<HealthRecyclerViewAdapter.MyViewHolder> {

    Context mContext;
    List<ServiceProvider> mData;
    Dialog myDialog;

    public HealthRecyclerViewAdapter(Context mContext, List<ServiceProvider> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.health_list, parent, false);
        final MyViewHolder vHolder = new MyViewHolder(v);

        //get to dialog layout attributes
        myDialog = new Dialog(HealthRecyclerViewAdapter.this.mContext);
