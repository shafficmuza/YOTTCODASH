...
public class SPDash extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.cbs : i = new Intent(this.getActivity(), CSOsActivity.class);startActivity(i); break;
            case R.id.police : i = new Intent(this.getActivity(), PoliceActivity.class);startActivity(i); break;
            case R.id.health_centre : i = new Intent(this.getActivity(), HealthActivity.class);startActivity(i); break;
