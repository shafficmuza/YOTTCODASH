...
public class CSOsRecyclerViewAdapter extends RecyclerView.Adapter<CSOsRecyclerViewAdapter.MyViewHolder> {

    Context mContext;
    List<ServiceProvider> mData;
    Dialog myDialog;

    public CSOsRecyclerViewAdapter(Context mContext, List<ServiceProvider> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.csos_list, parent, false);
        final MyViewHolder vHolder = new MyViewHolder(v);

        //get to dialog layout attributes
        myDialog = new Dialog(CSOsRecyclerViewAdapter.this.mContext);
